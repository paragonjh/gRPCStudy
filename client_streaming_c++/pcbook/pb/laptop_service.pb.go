...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x13, 0x69, 0x6d, 0x61, 0x67, 0x65,
	0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x71,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x32, 0x71, 0x0a, 0x0d,
	0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x60, 0x0a,
...
var file_laptop_service_proto_goTypes = []interface{}{
	(*UploadImageRequest)(nil),  // 0: techschool.pcbook.UploadImageRequest
	(*UploadImageResponse)(nil), // 1: techschool.pcbook.UploadImageResponse
	(*ImageInfo)(nil),           // 2: techschool.pcbook.ImageInfo
}
var file_laptop_service_proto_depIdxs = []int32{
	2, // 0: techschool.pcbook.UploadImageRequest.info:type_name -> techschool.pcbook.ImageInfo
	0, // 1: techschool.pcbook.LaptopService.UploadImage:input_type -> techschool.pcbook.UploadImageRequest
	1, // 2: techschool.pcbook.LaptopService.UploadImage:output_type -> techschool.pcbook.UploadImageResponse
...
func (c *laptopServiceClient) UploadImage(ctx context.Context, opts ...grpc.CallOption) (LaptopService_UploadImageClient, error) {
	stream, err := c.cc.NewStream(ctx, &_LaptopService_serviceDesc.Streams[0], "/techschool.pcbook.LaptopService/UploadImage", opts...)
	if err != nil {
		return nil, err
	}
