...
type Laptop struct {
	...
	Gpus     []*GPU     `protobuf:"bytes,6,rep,name=gpus,proto3" json:"gpus,omitempty"` //repeated: Array, list와 같은 용도
	...
	ReleaseYear uint32          `protobuf:"varint,13,opt,name=release_year,json=releaseYear,proto3" json:"release_year,omitempty"` //google.protobuf.Timestamp updated_at = 14; //well-known types: Library에서 지원하는 Type
}
...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf1, 0x03,
	...
	0x61, 0x73, 0x65, 0x59, 0x65, 0x61, 0x72, 0x42, 0x08, 0x0a, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68,
